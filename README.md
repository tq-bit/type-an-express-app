...
1. Convert CommonJs to ES6 module syntax (if you're asking yourself whether this is really necessary: It is not (really), but you would be using the same syntax to import modules and types). And if you wonder what the difference is, check out this [thread on Stackoverflow](https://stackoverflow.com/questions/31354559/using-node-js-require-vs-es6-import-export)
